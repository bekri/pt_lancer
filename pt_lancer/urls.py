"""
URL configuration for pt_lancer project.
...
urlpatterns = [
    ...
    path('verification/', TemplateView.as_view(template_name='accounts/verify.html'), name='frontend_verification'),  # Add this line for the verification page
